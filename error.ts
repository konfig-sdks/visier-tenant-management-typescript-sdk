...
/**
 * This class provides a wrapper for network errors when making requests to Visier Tenant Management APIs
 */
export class VisierTenantManagementError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierTenantManagementError";
